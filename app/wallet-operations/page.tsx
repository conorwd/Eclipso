// app/wallet-operations/page.tsx
"use client";
...
const BasicList = dynamic(() => import('../../components/BasicList'), { ssr: false });

const WalletOperationsPage: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center p-4 pt-16"> {/* Reduced top padding */}
      <div className="w-full max-w-4xl">
        <h1 className="text-3xl font-bold text-center mb-1 text-white">Eclipso Wallet Operations</h1> {/* Reduced font size and margin */}
        <p className="text-lg text-center mb-4 text-gray-300">Burn Tokens, Close Accounts, and Re-Claim Rent Fees</p> {/* Reduced font size and margin */}
